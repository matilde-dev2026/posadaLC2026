...
if (containerStart !== -1) {
  code = code.substring(0, containerStart) + '<div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: "30px" }}>' + code.substring(containerStart + 71);
}
