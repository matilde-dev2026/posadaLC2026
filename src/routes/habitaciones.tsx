...
const rooms = [
  {
    id: "11",
    name: "Habitación 11 - Quíntuple",
    description:
      "Confortable y espaciosa habitación quíntuple con baño privado, agua caliente y un ambiente acogedor y tranquilo, perfecta para familias o grupos.",
    price: 55,
    guests: 5,
    color: "#C86D43",
    images: [
      "/habitaciones/habitacion-11-0.jpg",
      "/habitaciones/habitacion-11-1.jpg",
      "/habitaciones/habitacion-11-2.jpg",
    ],
  },
  {
    id: "27",
    name: "Habitación 27 - Triple",
    description:
      "Espaciosa y acogedora habitación triple con baño privado y todas las comodidades, ideal para una estancia confortable en grupo o familia.",
    price: 40,
    guests: 3,
    color: "#A84B2C",
    images: [
      "/habitaciones/habitacion-27-0.jpg",
      "/habitaciones/habitacion-27-1.jpg",
      "/habitaciones/habitacion-27-2.jpg",
    ],
  },
  {
    id: "41",
    ...
    description:
      "Ideal para parejas, cuenta con cama matrimonial, baño privado y todas las comodidades.",
    price: 35,
    guests: 2,
    color: "#D96C3B",
    images: [
      "/habitaciones/habitacion-41-0.jpg",
      "/habitaciones/habitacion-41-1.jpg",
      "/habitaciones/habitacion-41-2.jpg",
    ],
  },
  {
    id: "43",
    name: "Habitación 43 - Séxtuple",
    description:
      "Amplia y acogedora habitación séxtuple con baño privado y excelente iluminación, perfecta para familias numerosas o grupos de viaje.",
    price: 65,
    guests: 6,
    color: "#B85732",
    images: [
      "/habitaciones/habitacion-43-0.jpg",
      "/habitaciones/habitacion-43-1.jpg",
      "/habitaciones/habitacion-43-2.jpg",
    ],
  },
  {
    id: "44",
    ...
    color: "#C65330",
    images: [
      "/habitaciones/habitacion-44-0.jpg",
      "/habitaciones/habitacion-44-1.jpg",
      "/habitaciones/habitacion-44-2.jpg",
    ],
  },
  {
    id: "45",
    ...
    description:
      "Perfecta para amigos o compañeros de viaje, incluye dos camas individuales y baño privado.",
    price: 35,
    guests: 2,
    color: "#B23B22",
    images: [
      "/habitaciones/habitacion-45-0.jpg",
      "/habitaciones/habitacion-45-1.jpg",
      "/habitaciones/habitacion-45-2.jpg",
    ],
  },
];
              ...
              {room.images.map((_, idx) => (
                <div
                  ...
                  style={{
                    ...
                    height: "8px",
                    borderRadius: "50%",
                    backgroundColor: idx === currentImage ? "white" : "rgba(255,255,255,0.5)",
      ...
      >
        ...
        <div
          style={{
            ...
            alignItems: "center",
            paddingTop: "20px",
            borderTop: "1px solid color-mix(in oklch, var(--primary-foreground) 25%, transparent)",
          }}
        >
          <div>
            <div
    ...
    >
      <header className="site-header">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "28px" }}>
          ...
          >
            ...
            <span style={{ color: "var(--ink)", fontWeight: "bold", fontSize: "1.1rem" }}>
              {cart.length}
            </span>
          </button>
        </div>
      ...
      <main style={{ padding: "40px 0 0 0" }}>
        <div style={{ textAlign: "center", marginBottom: "60px", padding: "0 max(30px, 5vw)" }}>
          ...
          >
            Selecciona las habitaciones de tu preferencia, añádelas al carrito y consulta la
                    ...
                    >
                      ...
                      <div className="form-group">
                        ...
                        <textarea
                          ...
                          onChange={handleInputChange}
                          placeholder="Ej: ¿Tienen desayuno incluido?"
                          style={{
                            width: "100%",
                            padding: "10px",
                            borderRadius: "6px",
